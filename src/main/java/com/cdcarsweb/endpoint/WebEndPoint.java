...
package com.cdcarsweb.endpoint;

import com.cdcarsweb.model.Email;
import com.cdcarsweb.model.Message;
...
@Api(
    ...
    namespace =
      @ApiNamespace(
        ownerDomain = "cdcarsweb.com",
        ownerName = "cdcarsweb.com",
        packagePath = ""
      )
    )
...
public class WebEndPoint {
   ...
   */
  // [START echo_method]
  @ApiMethod(name = "echo", httpMethod = ApiMethod.HttpMethod.GET, path = "echo/{name}")
  public Message echo(@Named("name") String name) {
   ...
   */
  // [START echo_path]
  @ApiMethod(name = "echo_path_parameter",httpMethod = ApiMethod.HttpMethod.GET, path = "echo/{name}/{n}")
  public Message echoPathParameter(@Named("name") String name, @Named("n") int n) {
	  Message message = new Message();
	  message.setMessage(name);
